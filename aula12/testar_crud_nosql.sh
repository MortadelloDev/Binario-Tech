...
RESP=$(curl -s POST http://localhost:3000/api/v1/manutencoes \
...
echo -e "\n[2] Consultando manutenções com Custo Maior ou Igual a R$ 1000 R$ 1000 ($gte)..."
curl -s "http://localhost:3000/api/v1/manutencoes?minCusto=1000" | jq .

echo -e "\n[3] Atualizado Status da Manutenção (ID: $ID) para CONCLUIDA..."
